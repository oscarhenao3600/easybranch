...
async function createWingsBranch() {
    try {
        console.log('🍗 Creando sucursal para Wings Master...\n');
        
        // Conectar a MongoDB
        await mongoose.connect('mongodb://localhost:27017/easybranch');
        console.log('✅ Conectado a MongoDB\n');
        
        // Crear sucursal para Wings Master
        const wingsBranch = new Branch({
            branchId: 'WINGS001-CENTRO',
            businessId: 'WINGS001', // ID del negocio existente
...
• Todos los precios incluyen IVA`;
        ...
        console.log('\n🎉 ¡Sucursal de Wings Master creada exitosamente!');
        console.log('📊 Resumen:');
